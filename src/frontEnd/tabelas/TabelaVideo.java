...
public class TabelaVideo extends javax.swing.JPanel {
    ...
    public void atualizarTabela() {
        List<Produto> produtos = listarProdutos("videos");
        List<Video> listaAtualizada = new ArrayList<>();
        // coloca os dados de produtos em lista atualizada
        for (Produto p : produtos) {
            if (p instanceof Video) {
                listaAtualizada.add((Video) p);
            }
        }

        carregarVideo(listaAtualizada);
    }
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 745,
                                                Short.MAX_VALUE))
                                .addContainerGap()));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (modelRow < 0 || modelRow >= videos.size())
                return;

            final Video v = videos.get(modelRow);
            SwingUtilities.invokeLater(() -> {
                VideoTela tela = new VideoTela(v, this::atualizarTabela);
