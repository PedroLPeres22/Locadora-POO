...
import dados.Game;
import dados.Video;
import frontEnd.formularios.FormularioEditarVideo;
...
public class VideoTela extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger
            .getLogger(VideoTela.class.getName());
    ...
    public VideoTela(Video video, Runnable callback) {
        initComponents();
        this.video = video;
    ...
    private void atualizarDadosVideo() {
        this.video = (Video) encontrarProduto(this.video.getCodigo(), "videos");
        if (this.video != null) {
            nome.setText(video.getNome());
            estudio.setText(video.getEstudio());
            distribuidora.setText(video.getDistribuidora());
            tipoMidia.setText(video.getTipoMidia());
            duracao.setText(String.valueOf(video.getDuracao()));
            clasInd.setText(video.getClassInd() == null ? "-" : video.getClassInd());
            estoque.setText(String.valueOf(video.getEstoque()));
            alugado.setText(video.estaAlugado() ? "Sim" : "Não");
            preco.setText("R$ " + video.getPreco());
            // botão "Alugar" só fica habilitado se não estiver alugado
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jBotoes, javax.swing.GroupLayout.DEFAULT_SIZE, 623,
                                                Short.MAX_VALUE))
                                .addContainerGap()));
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoExcluirActionPerformed
        int resposta = javax.swing.JOptionPane.showConfirmDialog(this, "Tem certeza que deseja excluir este vídeo?",
    ...
    private void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_botaoEditarActionPerformed
        FormularioEditarVideo tela = new FormularioEditarVideo(this.video, this::atualizarDadosVideo);
