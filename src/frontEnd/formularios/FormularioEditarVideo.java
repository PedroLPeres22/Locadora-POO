...
public class FormularioEditarVideo extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FormularioEditarVideo.class.getName());
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(formularioContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 488, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void botaoEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEnviarActionPerformed
        ...
        this.video.setDuracao(Integer.parseInt(tfDuracao.getText()));
        ...
        this.video.setEstoque(Integer.parseInt(tfEstoque.getText()));
        this.video.setFormato(tfFormato.getSelectedItem().toString());
        this.video.setPreco(Integer.parseInt(tfPreco.getText()));

        editarProduto(this.video.getCodigo(), "videos", this.video);
        JOptionPane.showMessageDialog(formularioContainer, "Video " + this.video.getNome() + " editado atualize os dados");
        if (callback != null) {
