 ...
 * @author gbert
 */
public class TabelaJogos extends javax.swing.JPanel {
    ...
    public void atualizarTabela() {
        List<Produto> produtos = listarProdutos("jogos");
        List<Game> listaAtualizada = new ArrayList<>();
        //coloca os dados de produtos em lista atualizada
        for (Produto p : produtos) {
            if (p instanceof Game) {
                listaAtualizada.add((Game) p);
            }
        }

        carregarJogos(listaAtualizada);
    }
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 651,
                                                Short.MAX_VALUE)
                                        .addGroup(layout.createSequentialGroup()
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (modelRow < 0 || modelRow >= jogos.size())
                return;

            final Game g = jogos.get(modelRow);
            SwingUtilities.invokeLater(() -> {
                JogoTela tela = new JogoTela(g, this::atualizarTabela);
